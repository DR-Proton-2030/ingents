...
const YouTubeStatsDashboard = () => {
  ...
  // const { data: rawData } = useYouTubeDetails(user?._id, dateRange);
        ...
        <div className="min-h-screen bg-[#EAEEF6] flex flex-col items-center justify-center p-8">
          <div className="bg-white p-12 rounded-[50px] shadow-2xl shadow-blue-100 text-center max-w-md border border-white">
            ...
            <p className="text-slate-500 font-medium mb-10 leading-relaxed">
              {error ||
                "We couldn't reach your YouTube data. Ensure your channel is properly linked."}
            </p>
            <Link
          ...
          {data?.channel?.branding?.image?.bannerExternalUrl && (
            <div className="relative w-full h-48 rounded-[50px] overflow-hidden mb-12 shadow-2xl border-4 border-white">
              ...
              <div className="absolute bottom-6 right-8">
                <span className="bg-red-600 text-white px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest shadow-lg animate-pulse">
                  Live Dashboard
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-8">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-4">
                  <span className="px-5 py-2 rounded-2xl bg-white/60 backdrop-blur-sm text-xs font-black text-slate-600 uppercase tracking-widest border border-white/50">
                    {data?.channel?.handle}
                  </span>
                  ...
                  <span className="w-2 h-2 rounded-full bg-slate-300" />
                  <span className="text-base font-black text-slate-500">
                    {formatCompactNumber(data?.channel?.statistics?.viewCount)}{" "}
                    <span className="text-xs font-bold uppercase tracking-widest text-slate-400 ml-1">
                      Views
                    </span>
                  </span>
                  <span className="w-2 h-2 rounded-full bg-slate-300" />
                  <span className="text-base font-black text-slate-500">
                    {formatCompactNumber(data?.channel?.statistics?.videoCount)}{" "}
                    <span className="text-xs font-bold uppercase tracking-widest text-slate-400 ml-1">
                      Videos
                    </span>
                  </span>
                  ...
                  <span className="px-4 py-1.5 rounded-xl bg-slate-100 text-[10px] font-black text-slate-600 uppercase tracking-widest flex items-center gap-2">
                    <img
                      src={`https://flagcdn.com/w20/${data?.channel?.branding?.channel?.country?.toLowerCase() || "in"}.png`}
                      ...
                      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                        <div className="p-6 rounded-[35px] bg-blue-50/50 border border-blue-100/50">
                          ...
                          <h4 className="text-3xl font-black text-slate-900">
                            {formatCompactNumber(
                              data.dashboard.overview28d.totalViews,
                            )}
                          </h4>
                        </div>
                        <div className="p-6 rounded-[35px] bg-emerald-50/50 border border-emerald-100/50">
                          ...
                          <h4 className="text-3xl font-black text-slate-900">
                            {Number(
                              data.dashboard.overview28d.totalWatchTimeHours ||
                                0,
                            ).toFixed(2)}
                          </h4>
                        </div>
                        <div className="p-6 rounded-[35px] bg-red-50/50 border border-red-100/50">
                          ...
                          <h4 className="text-3xl font-black text-slate-900">
                            ...
                            {formatCompactNumber(
                              Math.round(
                                data.dashboard.overview28d.subscribersGained ||
                                  0,
                              ),
                            )}
                          </h4>
                        ...
                        <div className="p-6 rounded-[35px] bg-slate-50 border border-slate-100">
                          ...
                          <h4 className="text-3xl font-black text-slate-900">
                            {formatCompactNumber(
                              Math.round(
                                data.dashboard.overview28d.netSubscribers || 0,
                              ),
                            )}
                          </h4>
                        </div>
                  ...
                  <DemographicsCharts
                    demographics={{
                      ...
                      operatingSystems:
                        ...
                        data?.demographics?.operatingSystems ||
                        [],
                    }}
                  />
                  ...
                  <div className="p-6 rounded-[30px] bg-green-50/30 border border-green-50 flex justify-between items-center group/item hover:bg-green-50/50 transition-colors">
                    <div className="flex flex-col">
                      ...
                      <span className="text-3xl font-black text-green-600">
                        ...
                        {formatCompactNumber(
                          Math.round(
                            data?.analytics?.overview?.subscribersGained || 0,
                          ),
                        )}
                      </span>
                    </div>
                  ...
                  <div className="p-6 rounded-[30px] bg-red-50/30 border border-red-50 flex justify-between items-center group/item hover:bg-red-50/50 transition-colors">
                    <div className="flex flex-col">
                      ...
                      <span className="text-3xl font-black text-red-600">
                        ...
                        {formatCompactNumber(
                          Math.round(
                            data?.analytics?.overview?.subscribersLost || 0,
                          ),
                        )}
                      </span>
                    </div>
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <h4 className="text-5xl font-black text-blue-600 tracking-tighter">
                      {formatCompactNumber(
                        Math.round(
                          data?.analytics?.overview?.netSubscribers || 0,
                        ),
                      )}
                    </h4>
                  </div>
