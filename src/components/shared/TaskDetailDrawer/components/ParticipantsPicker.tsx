...
import { CloseCircle, MinusCircle, AddCircle } from "@solar-icons/react";
    ...
    return (
        <div className="p-6">
            <div className="flex items-center justify-between mb-6">
                <h4 className="text-xl font-bold text-gray-800">Assign Teammates</h4>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between px-1 border-b border-gray-100 pb-2">
                        <h5 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Selected Assignees ({assignees?.length || 0})</h5>
                    </div>
                    <div className="space-y-2 max-h-[260px] overflow-y-auto pr-1">
                        {assignees?.map((u: any) => (
                            <div key={u._id} className="flex items-center gap-3 p-3 bg-white rounded-2xl border border-gray-100 hover:border-orange-100 transition-all group">
                                ...
                                <button type="button" onClick={() => onRemoveAssignee(u._id)} className="p-2 text-gray-300 hover:text-red-500 hover:bg-red-50 rounded-xl transition-all">
