        ...
        <div className="space-y-6">
            ...
            {!isCreating ? (
                <button
                    ...
                    className="w-full h-11 bg-gray-100 rounded-full flex items-center justify-center gap-2 text-sm
                    hover:text-black hover:bg-gray-200 transition-all duration-200 cursor-pointer
                   "
                >
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between px-1 border-b border-gray-100 pb-2">
                    <h5 className="text-[10px]  text-gray-400 ">Available Tags</h5>
                </div>
                            ...
                            {filteredTags.map((tag) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={cn(
                                            "inline-flex items-center px-2.5 py-1 gap-1 text-[13px]  whitespace-nowrap border border-gray-200 rounded-lg transition-all",
                                            isSelected
                                                ? " border-red-300 "
                                    ...
                                    >
                                        <Tag className={cn("w-3 h-3 shrink-0 ", isSelected ? "text-red-500" : "text-gray-500")} />
                                        <span className="truncate max-w-[120px]  ">
                                            {tag.name}
                                        </span>
                                        {isSelected ? (
                                            <MinusCircle className="w-3.5 h-3.5 text-red-500 cursor-pointer shrink-0  hover:bg-red-500 hover:text-white rounded-full" />
                                        ) : (
                                            <AddCircle className="w-3.5 h-3.5 cursor-pointer shrink-0 opacity-40 hover:opacity-80 transition-opacity" />
                                        )}
                                    </button>
                                );
                            })}
