...
const Campaigns: React.FC = () => {
  ...
  return (
    <Layout showSidebar={true}>
      <div className="mx-auto max-w-7xl px-4 space-y-6 animate-in fade-in duration-500">
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                <input
                  ...
                  className="pl-10 pr-4 py-3 bg-white backdrop-blur-md shadow-xl shadow-gray-100 rounded-full focus-none outline-none transition-all w-[25rem]"
                />
              </div>
              <button
                onClick={() => setView("create_selection")}
                className="flex  cursor-pointer items-center gap-2 bg-blue-500 hover:bg-blue-600  text-white px-4 py-3 rounded-full font-medium transition-all "
              >
        ...
        {view === "overview" && (
          <>
            {loading ? (
              ...
              <div className="bg-white/70 w-[40rem] mx-auto mt-20 rounded-3xl p-16 flex flex-col items-center justify-center text-center space-y-6">
                <div className="">
                  <Boombox className="text-orange-600/50" size={80} />
                </div>
                <div className="space-y-2">
                  <div className="text-2xl font-semibold text-black/80">No active campaigns yet</div>
                ...
                <div
                  onClick={() => setView("create_selection")}
                  className="bg-gray-200 mt-2 hover:bg-gray-300 cursor-pointer text-black/80 w-fit px-4 py-2.5 rounded-xl mx-auto">Lets create a campaign</div>
