        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="relative group w-full sm:w-64">
            ...
            <input
              ...
              className="pl-11 pr-4 py-2.5 bg-white rounded-2xl text-sm w-full focus:outline-none focus:ring-4 focus:ring-orange-500/5 focus:border-orange-500/40 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.03)] transition-all placeholder:text-gray-400 font-semibold"
            />
          </div>
          {/* Status Pills */}
          <div className="flex items-center bg-gray-100/70 p-1.5 rounded-2xl gap-1.5 border border-gray-200/30">
            <button
              ...
              className={`px-5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${activeTabId === "all"
            ...
            {nonEmptySections.map((sec: any) => (
              <button
                ...
                className={`px-5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${activeTabId === sec.id
                    ? "bg-white text-gray-900 shadow-sm border border-gray-100/40 font-semibold"
                    : "text-gray-500 hover:text-gray-800"
                  }`}
              >
