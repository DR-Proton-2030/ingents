    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 scrollbar-hide">
          <form onSubmit={handleSubmit} id="create-subtask-form" className="space-y-8 pb-6">
            {/* Primary Details */}
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest ml-1 mb-1.5">Subtask Title *</label>
                  <input
                    name="title"
                    value={formData.title}
                    onChange={handleChange}
                    placeholder="e.g. Audit documentation"
